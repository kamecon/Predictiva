...
#Cargamos los datos
Advertising <- read_csv("Intro/Advertising.csv")

#Revisamos los nombres de las columnas
colnames(Advertising)

#Cambiamos el primer nombre
colnames(Advertising)[1] <- "market"

#Miramos los datos "por encima"
head(Advertising)
str(Advertising)
...
plot(Advertising$TV, Advertising$sales, xlab = "TV", ylab = "Ventas")
plot(Advertising$TV, Advertising$sales, xlab = "TV", ylab = "Ventas", col=2)
abline(lm(data = Advertising, formula = sales~TV))

#Graficar el resto
plot(Advertising$, Advertising$sales, xlab = "", ylab = "Ventas", col=2)
abline(lm(data = Advertising, formula = sales~))
